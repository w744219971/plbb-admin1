 ...
 */
package tv.vnet.plbb.admin.modules.quartz.rest;
...
public class QuartzJobController {
    ...
    public ResponseEntity<Object> updateQuartzJob(@Validated(BaseEntity.Update.class) @RequestBody QuartzJob resources){
        // 验证Bean是不是合法的，合法的定时任务 Bean 需要用 @Service 定义
        checkBean(resources.getBeanName());
