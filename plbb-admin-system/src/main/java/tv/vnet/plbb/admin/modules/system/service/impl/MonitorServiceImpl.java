...
import tv.vnet.plbb.admin.modules.system.service.MonitorService;
import tv.vnet.plbb.admin.utils.PlbbAdminConstant;
...
public class MonitorServiceImpl implements MonitorService {
    ...
    private Map<String,Object> getDiskInfo(OperatingSystem os) {
        ...
        for (OSFileStore fs : fsArray){
            ...
            if(osName.toLowerCase().startsWith(PlbbAdminConstant.WIN)) {
